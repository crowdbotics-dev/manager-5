"""
Django settings for manager_5 project.
...
WSGI_APPLICATION = 'manager_5.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "manager Support <support@manager-5.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "manager_5 API",
    "DESCRIPTION": "API documentation for manager_5 App",
    "VERSION": "v1",
}
